...
import { MdxFigcaption } from "@/components/content/MdxFigcaption"
...
export default async function ArticlePage({
  ...
  const articleUrl = `${SITE_URL}/editorial/${article.slug}`;
  ...
  const articleJsonLd = {
    ...
    ...(article.heroBand && {
      image: {
        "@type": "ImageObject",
        contentUrl: `${SITE_URL}${article.heroBand}`,
        description: article.heroAlt,
        caption: article.heroCaption,
        creator: { "@id": `${SITE_URL}/#elias` },
        creditText: "Elías Hernández",
        copyrightNotice: "© Elías Hernández",
      },
    }),
  };
      ...
      <main className="mx-auto w-full max-w-5xl px-6 py-16 flex flex-col gap-8">  
        ...
        {article.heroBand && (
          <figure className="not-prose flex flex-col gap-2">
            ...
            <MdxFigcaption caption={article.heroCaption} credit={article.heroCredit}/>
          </figure>
        )}
